...
@dataclass
class DFTDataConfig(_DataConfig):
    """Data configuration for DFT training."""

    train_data_path: str = ""
    max_length: int = 1024
    dataset_processor_path: str = ""
    sp_size: int = 1
    dft_mini_scale: float = 0.0


@dataclass
class DFTConfig(_Config):
    """Top-level configuration for DFT preset."""

    data_config: DFTDataConfig = field(default_factory=DFTDataConfig)

    @classmethod
    def from_flat_dict(cls, d: dict) -> "DFTConfig":
        ...
        data_config = {
            ...
            "dft_mini_scale": d.get("dft_mini_scale", 0.0),
        }
